...
// Wed Jul 17 10:15:31 2013 by ROOT version 5.34/05
// from TTree T/Tree
// found on file: /tmp/xx13196165454.hld.root
//////////////////////////////////////////////////////////

#ifndef analyze_trb3_h
#define analyze_trb3_h
...
const Int_t kMaxTDCHits = 80;
const Int_t kMaxADCHits = 1;

class analyze_trb3 : public TSelector {
public :
 ...
 //Event           *event;
   ...
   Float_t         TDCHits_fineTime1[kMaxTDCHits];   //[TDCHits_]
   ...
   analyze_trb3(TTree * /*tree*/ =0) : fChain(0) { }
   virtual ~analyze_trb3() { }
   ...
   ClassDef(analyze_trb3,0);
};

#endif

#ifdef analyze_trb3_cxx
void analyze_trb3::Init(TTree *tree)
{
   ...
   fChain->SetBranchAddress("TDCHits.fineTime1", TDCHits_fineTime1, &b_TDCHits_fineTime1);
